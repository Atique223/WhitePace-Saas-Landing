            ...
            <div className='relative w-[90%] flex flex-col-reverse md:flex-row justify-evenly items-center'>
                ...
                <div className='md:w-[527px] md:h-[314] text-black flex flex-col text-center md:items-start items-center mb-10'>
                 ...
                 />
                  ...
                  <p className='font-normal flex flex-col text-center md:items-start items-center mb-10'>With whitepace, share your notes with your colleagues and collaborate on them.You can also publish a note to the internet and share the URL with others.</p>
